  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        children: [
          ...
          IconButton(
            ...
            onPressed: ref.read(darkModeProvider.notifier).toogleDarkMode,
          ),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: () {
          final String name = RandomGenerator.getRandomName();
          ref.read(usernameProvider.notifier).changueName(name);
        },
      ),
    );
  }
